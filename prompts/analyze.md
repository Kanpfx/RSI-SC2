...
Do not change the evaluator, framework, tests, or experiment configuration.
Return ONLY a JSON object: {"problem": "...", "candidates": ["...", "..."]}.
Each candidate must describe one main change to bot/.
